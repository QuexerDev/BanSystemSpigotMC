        ...
        if(sender.hasPermission("ban.ban")) {
            if(args.length == 1) {
                ...
                if(BanAPI.isBanned(name)) {
                    ...
                    sender.sendMessage("§7GrundÂ§8: §e"+BanAPI.getGrund(name));
                } else {
                ...
                if(MuteAPI.isMuted(name)) {
                    ...
                    sender.sendMessage("§7GrundÂ§8: §e"+MuteAPI.getGrund(name));
                } else {
                ...
                sender.sendMessage(Main.pf+"§7BenutzeÂ§8: §c/check <Name>");
            }
